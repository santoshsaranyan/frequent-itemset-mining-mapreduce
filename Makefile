...
# -----------------------------------------------------------
hadoop.root=/Users/santoshsaranyan/myhadoop/hadoop-3.2.2
...
hdfs.user.name=santoshsaranyan
hdfs.input=input
hdfs.output=output
# AWS EMR Execution
aws.emr.release=emr-6.5.0
aws.region=us-east-1
aws.bucket.name=cs6240santosh
...
# Upload data to S3 input dir.
upload-temporary-aws: make-bucket
	aws s3 sync ${local.temporary} s3://${aws.bucket.name}/${aws.temporary}
